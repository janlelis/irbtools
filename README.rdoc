...
<tt>irbtools-more</tt> adds some more irb gems which may not build out-of-the-box: currently - better auto completion and an object inspector.
...
* You need +tk+ for the object inspector (maybe try <tt>tk_as_gem</tk>)
...
* Feel free to build your own extension package gem and upload it to rubygems ;)

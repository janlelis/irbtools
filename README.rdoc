...
By the way: You can get about 0.1 - 0.3 seconds faster start-up time by changing the loading methods for wirb and fancy_irb to <tt>:thread</tt> (only drawback: the hash rocket will not be used for the first result).
